...
class Variant(BaseModel):
    ...
    option1 = models.ForeignKey(OptionValue, related_name='variant', on_delete=models.SET_NULL, null=True)
    option2 = models.ForeignKey(OptionValue, related_name='variant', on_delete=models.SET_NULL, null=True)
    option3 = models.ForeignKey(OptionValue, related_name='variant', on_delete=models.SET_NULL, null=True)
    ...
    image = models.ForeignKey(Image, related_name='variant', on_delete=models.SET_NULL)
